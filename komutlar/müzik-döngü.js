...
.setColor(AloneDogru)
.setTitle("Voixy  |  Döngü")
.setDescription(`<:a_:1109866752428490974>  | Müzik döngüsü, ${message.author} tarafından \`aktif\` edildi.`) 
...
.setColor(AloneDogru)
.setTitle(" Voixy  | Döngü")
.setDescription(`<:a_:1109866752428490974>  | Müzik döngüsü, ${message.author} tarafından \`de-aktif\` edildi.`) 
.setThumbnail(`https://drummofficial.com/wp-content/uploads/2017/08/equalizer3.gif`)
.setFooter(`©️ Tüm hakları saklıdır | Yeni Nesil Gelişmiş Bot | 2023`, client.user.avatarURL());  
...
.setTitle("• Hata: 008 •")
.setThumbnail(`https://drummofficial.com/wp-content/uploads/2017/08/equalizer3.gif`)
.setDescription(`<:a_:1109866752428490974>   | Döngüyü ayarlayabilmek için bir ses kanalında olmanız gerekmektedir!`)
