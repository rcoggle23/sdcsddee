...
.setDescription(`<:a_:1109866752428490974>   | Kuyruğu görüntüleyebilmek için bir ses kanalında olmanız gerekmektedir!`)
...
return `${i === 0 ? '<:a_:1109866752428490974>   | Şu Anda Çalınan Müzik' : `\nKuyruk No: ${i}`} \n**Müziğin Adı:** \`${song.name}\` \n**Müziği Yükleyen Kanal:** \`${song.author}\``
    }).join('\n');  
